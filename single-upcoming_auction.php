			...
			<?php echo get_the_post_thumbnail(); ?>
				<?php the_title('<h2>','</h2>'); ?>
		 		...
		 		<div class="real_post_meta">
		 			<?php $real_s_date = get_post_meta( $post->ID, 'upcoming_auction_date', true ); ?>
		 			<?php $real_s_price = get_post_meta( $post->ID, 'upcoming_auction_price', true ); ?>
		 			<?php $real_s_place = get_post_meta( $post->ID, 'upcoming_auction_place', true ); ?>
		 			<?php $real_s_link = get_post_meta( $post->ID, 'upcoming_auction_link', true ); ?>
