    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center title">
                ...
                <p>The Below Auction Data Queried On  
                 <?php 
...
<!-- /search result -->
                ...
                <div class="get-mebrsp-btn">
                        <a href="http://carauctioninc.us.tempcloudsite.com/car/m_level/"><button class="btn">Activate Your Membership Today!</button></a>
                    </div>
                    <!-- /.col-md-12 -->
            </div>
        </div>
